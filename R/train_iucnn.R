...
#'for instance generated by \link{geo_features}, |link{clim_features}, and \link{biome_features},
...
#'subsequent columns with different features, in the same order as used for \link{tpredict_iucnn}.
...
#'
#'
#'@note See \link{vignette{"Approximate_IUCN_Red_List_assessments_with_IUCNN"} for a
